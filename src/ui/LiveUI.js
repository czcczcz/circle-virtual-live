...
const time = (s) =>
  `${Math.floor((s || 0) / 60)
    ...
    .padStart(2, "0")}`;
export class LiveUI {
  constructor(songs, members, models = members) {
    document.querySelector("#app").innerHTML = `
 <div id="viewport" aria-label="三维演出舞台"></div><div class="vignette"></div>
 <header><a class="brand" href="./" aria-label="CiRCLE 首页"><span class="brand-mark">C<span>•</span></span><span>CiRCLE<small>沉浸式虚拟 LIVE HOUSE</small></span></a><nav><span class="live-pill"><i></i> 沉浸现场</span><button id="library-toggle" class="nav-action">歌曲</button><button id="band-toggle" class="nav-action">阵容</button><button id="settings-toggle" class="icon-button" aria-label="演出设置">☷</button></nav></header>
 <section class="title-block"><div class="eyebrow">今夜，我们都是闪耀的星。</div><h1>Poppin’Party<span>at CiRCLE<span class="star">✦</span></span></h1><p>五颗心，一座舞台。你的专属前排。</p><div class="tag-row"><span>迷你舞台 01</span><span>梦想，从此刻奏响</span></div></section>
 ...
 <div class="welcome" id="welcome"><button id="start" class="start-button"><span>▶</span> 开始演出 <small>开声、亮灯，一起奔向星光</small></button><p>点击启用音频，进入你的专属 Live。</p></div>
 ...
 <div class="transport"><div class="transport-buttons"><button id="previous" aria-label="上一首" title="上一首">◂◂</button><button id="restart" aria-label="从头播放" title="从头播放">↺</button><button id="play" class="play-button" aria-label="播放">▶</button><button id="next" aria-label="下一首" title="下一首">▸▸</button></div><div class="timeline"><span id="elapsed">00:00</span><input id="seek" aria-label="播放进度" type="range" min="0" max="1000" value="0"><span id="duration">00:00</span></div></div>
 ...
 <div id="toast" role="status" aria-live="polite"></div>`;
  ...
  update(audio, beat, camera, fps) {
    ...
    this.$("shot-label").textContent =
      ...
      `机位 ${String(Object.keys(shots).indexOf(camera.shot) + 1).padStart(2, "0")} · ${shots[camera.shot].label}`;
